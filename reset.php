...
<head>
    ...
    <title>Reset password | UrbanCube</title>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500 " style="margin-bottom: 100px">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <form method="POST" action="reset_val.php" class="mt-4" autocomplete="off">
                            <input type="hidden" name="_token" value="S8UkUChxPIbd8icx6XG9vPsyVci7fQuuuhyTFiJb">
                            <div class="form-group mb-4"><label for="email_address">Your Email Address</label>
                                <div class="input-group"><span class="input-group-text" id="basic-addon1"><span
                                        class="fa fa-envelope"></span></span> <input id="email_address" type="email"
                                           class="form-control" name="email_address"
                                           value="" required autocomplete="email_address" autofocus>
</div>
