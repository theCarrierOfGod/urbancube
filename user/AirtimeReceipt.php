                        ...
                        <td class="content-wrap aligncenter">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody><tr>
                                    ...
                                    $sql = "SELECT * FROM `transactions` WHERE id='$ids'";
                                ...
                                <tr>
                                    <td class="content-block">
                                        <table class="invoice">
                                            <tbody><tr>
                                                <td><?php echo $network . ' ' .$type ?><br>Invoice  uc<?php echo $invoice ?><br><?php echo $time ?>
                                                <br>Phone Number: <?php echo $phone?>
                                                <br> Status: <?php echo $stats ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                        <tbody><tr>
                                                            <td><?php echo $packag ?></td>
                                                            <td class="alignright">N <?php echo $amount ?></td>
                                                        </tr>
