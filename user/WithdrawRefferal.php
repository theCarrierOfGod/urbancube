...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
   ...
   class="nav-item"><span class="nav-link d-flex justify-content-between align-items-center" data-toggle="collapse"
        ...
        <div class="row justify-content-md-center">
          ...
          <script type="text/javascript">
            $(document).ready(function () {
                $("#successRequestWithdraw").modal('show');
            });
        </script>
        <div id="successRequestWithdraw" class="modal fade" data-backdrop="static" data-keyboard="false" style="display: none;"
             aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="" style="font-size:14px">referral withdrawal is temporarily unavailable. it will be restored shortly</p>
                    </div><!-- modal-body -->
    ...
    <div class="card-body">
        ...
        <form method="post" autocomplete="off" action="RequestWithdrawReferral"  onsubmit="return checkForm(this);">
                                    <input type="hidden" name="_token" value="8vPngdkB7I12T7c8LzMJXA11Tk1fCjyoIWt3zQYn">

                                    <div class="">

                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3">Option</label>
                                            <div class="col-lg-12">
                                                    <select class="custom-select form-control"
                                                        name="option" required>
                                                      <option value="">select</option>
                                                    <option value="Process Cash to Wallet">Fund Wallet</option>
                                                        ...
                                                        <option value="Silver">Upgrade To Silver ₦1,500</option>
                                                   <option value="Gold">Upgrade To Gold ₦3,000</option>  
