...
<head>
    ...
    <title>Request Email Confirmation | UrbanCube</title>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500 " style="margin-bottom: 100px">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <form method="POST" action="confirm_val.php" class="mt-4" autocomplete="off">
                            ...
                            <div class="form-group mb-4"><label for="username">Your username</label>
                                <div class="input-group"><span class="input-group-text" id="basic-addon1"><span
                                        class="fa fa-envelope"></span></span> <input id="username" type="text"
                                           class="form-control" name="username"
                                           value="<?php echo $user; ?>" required autocomplete="username" autofocus>
</div>
                                                 <span class="blink_me text-danger"  role="alert">
 <p> <?php if(isset($_GET['error'])){ $err=$_GET["error"]; echo $err; } ?></p>
                                    </span>
                                                                        </div>
                            <button type="submit" class="btn btn-block btn-primary">Request Email</button>
                        </form>
                    </div>
                </div>
            </div>
